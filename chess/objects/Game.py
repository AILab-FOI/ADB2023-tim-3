...
class Game(Persistent):
    ...
    def initializeBlackPieces(self):
        b_pawn1=Piece(6,(0,6),"black","b_pawn1")
        self.board[0][6]=b_pawn1
        b_pawn2=Piece(6,(1,6),"black","b_pawn2")
        self.board[1][6]=b_pawn2
        b_pawn3=Piece(6,(2,6),"black","b_pawn3")
        self.board[2][6]=b_pawn3
        b_pawn4=Piece(6,(3,6),"black","b_pawn4")
        self.board[3][6]=b_pawn4
        b_pawn5=Piece(6,(4,6),"black","b_pawn5")
        self.board[4][6]=b_pawn5
        b_pawn6=Piece(6,(5,6),"black","b_pawn6")
        self.board[5][6]=b_pawn6
        b_pawn7=Piece(6,(6,6),"black","b_pawn7")
        self.board[6][6]=b_pawn7
        b_pawn8=Piece(6,(7,6),"black","b_pawn8")
        self.board[7][6]=b_pawn8

        b_rook1=Piece(3,(0,7),"black","b_rook1")
        self.board[0][7]=b_rook1
        b_rook2=Piece(3,(7,7),"black","b_rook2")
        self.board[7][7]=b_rook2

        b_bishop1=Piece(5,(2,7),"black","b_bishop1")
        self.board[2][7]=b_bishop1
        b_bishop2=Piece(5,(5,7),"black","b_bishop2")
        self.board[5][7]=b_bishop2
        b_knight1=Piece(4,(1,7),"black","b_knight1")
        self.board[1][7]=b_knight1
        b_knight2=Piece(4,(6,7),"black","b_knight2")
        self.board[6][7]=b_knight2

        b_king=Piece(1,(3,7),"black","b_king")
        self.board[3][7]=b_king
        b_queen=Piece(2,(4,7),"black","b_queen")
    ...
    def initializeWhitePieces(self):
            w_pawn1=Piece(6,(0,1),"white","w_pawn1")
            self.board[0][1]=w_pawn1
            w_pawn2=Piece(6,(1,1),"white","w_pawn2")
            self.board[1][1]=w_pawn2
            w_pawn3=Piece(6,(2,1),"white","w_pawn3")
            self.board[2][1]=w_pawn3
            w_pawn4=Piece(6,(3,1),"white","w_pawn4")
            self.board[3][1]=w_pawn4
            w_pawn5=Piece(6,(4,1),"white","w_pawn5")
            self.board[4][1]=w_pawn5
            w_pawn6=Piece(6,(5,1),"white","w_pawn6")
            self.board[5][1]=w_pawn6
            w_pawn7=Piece(6,(6,1),"white","w_pawn7")
            self.board[6][1]=w_pawn7
            w_pawn8=Piece(6,(7,1),"white","w_pawn8")
            self.board[7][1]=w_pawn8

            w_rook1=Piece(3,(0,0),"white","w_rook1")
            self.board[0][0]=w_rook1
            w_rook2=Piece(3,(7,0),"white","w_rook2")
            self.board[7][0]=w_rook2

            w_bishop1=Piece(5,(2,0),"white","w_bishop1")
            self.board[2][0]=w_bishop1
            w_bishop2=Piece(5,(5,0),"white","w_bishop2")
            self.board[5][0]=w_bishop2

            w_knight1=Piece(4,(1,0),"white","w_knight1")
            self.board[1][0]=w_knight1
            w_knight2=Piece(4,(6,0),"white","w_knight2")
            self.board[6][0]=w_knight2

            w_king=Piece(1,(3,0),"white","w_king")
            self.board[3][0]=w_king
            w_queen=Piece(2,(4,0),"white","w_queen")
    ...
    def makeMove(self,piece:Piece,nextPosition:List[int],gameId):
        ...
        if self.board[nextPosition[0]][nextPosition[1]] is not None:
            #self.board[nextPosition[0]][nextPosition[1]]= None
            self.board[nextPosition[0]][nextPosition[1]].currentPosition = [9, 9]
            pieceToRemove = self.board[nextPosition[0]][nextPosition[1]]
            database.updatePiece(pieceToRemove, pieceToRemove.name, gameId)
